    ...
    >
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight">Jesus Youth</h1>
          <p className="text-lg font-medium mt-1" style={{ color: 'rgba(199,214,254,0.9)' }}>
            Pala Missionaries
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl text-white placeholder-opacity-50 outline-none text-sm font-medium transition-all duration-200"
                style={{
                  background: 'rgba(255,255,255,0.1)',
              ...
              />
              {error && (
                <p className="mt-2 text-sm flex items-center gap-1.5" style={{ color: 'rgba(252,165,165,0.95)' }}>
